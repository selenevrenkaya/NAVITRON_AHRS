...
bool circ_buffer_write(t_circ_buffer *cbuffer, uint8_t *writeBlock, uint32_t block_size){
...
bool circ_buffer_read(t_circ_buffer *cbuffer, uint8_t *readBlock, uint32_t block_size){
